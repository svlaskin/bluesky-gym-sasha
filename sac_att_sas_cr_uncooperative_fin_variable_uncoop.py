"""Variable-uncooperative variant of sac_att_sas_cr_uncooperative_fin.py.

This is a new script and does not modify existing training files.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train SAC ATT in uncooperative SectorCR with configurable uncooperative count."
    )
    ...
    parser.add_argument(
        "--weights-folder",
        type=str,
        default="/Users/sasha/Documents/Code/pettingzoo_multiuse/sac_unc_cr_att_uncooperative_variable",
    )
    parser.add_argument("--csv-file", type=str, default="metrics_uncoop_variable.csv")
    parser.add_argument(
        "--render-mode",
        type=str,
        default="none",
