...
extra_str = "_sac_20drones_noise2_075" # selective and scaled
...
extra_str4 = "_ppo_20drones_noise_075"
...
if plot_reward:
    ...
    # plt.plot(ppo2['timesteps'][:-(ave_window-1)],moving_average(ppo[name],ave_window),label='ppo2')
...
if plot_intrusions:
    ...
    # plt.plot(ppo2['timesteps'][:-(ave_window-1)],moving_average(ppo[name2],ave_window),label='ppo2')
...
if plot_drift:
    ...
    # plt.plot(ppo2['timesteps'][:-(ave_window-1)],moving_average(ppo[name3],ave_window),label='ppo2')
