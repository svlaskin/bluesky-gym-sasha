...
def save_models(model, weights_folder = '/Users/sasha/Documents/Code/multiagent_merge/bluesky-gym/sac_unc_cr_att_uncooperative'):
...
env = sector_cr_v0.SectorCR_ATT_sas_uncoop(render_mode=None)
