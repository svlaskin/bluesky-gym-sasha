...
need_render = False
# env_c = sector_cr_v0.SectorCR_ATT_sas_quick(render_mode='human') if need_render else sector_cr_v0.SectorCR_ATT_sas_un(render_mode=None) # TODO:chg
...
env_unc = sector_cr_v0.SectorCR_ATT_sas_unc_quick(render_mode='human') if need_render else sector_cr_v0.SectorCR_ATT_sas_unc_quick(render_mode=None)
...
weights_folder_clean = "/Users/sasha/Documents/Code/pettingzoo_multiuse/sac_cr_att_posonly_20_5n_dt1_30m_rpz" # trained on ideal
...
weights_folder_noise = "/Users/sasha/Documents/Code/pettingzoo_multiuse/sac_unc_cr_att_noise_posonly_20_5n_dt1_30m_rpz"
...
run_pars = [
    # [weights_folder_clean, env_unc, 'cu'],
            ...
            #  [weights_folder_clean, env_c, 'cc'],
            #  [weights_folder_noise, env_c, 'uc']
             ]
...
for run_par in run_pars:
    ...
    log_name = f"logs_unc_cr_35std_trained_1sdt/log_{run_par[2]}.csv"
