...
# run_pars = [[weights_folder_clean, env_unc, 'cu'], [weights_folder_noise, env_unc, 'uu']]
run_pars = [[weights_folder_noise, env_unc, 'cu']]
run_epis = 5 # number of episodes to run per combo


for run_par in run_pars:
    # print(run_par)
    log_name = f"logs_unc_cr/log_{run_par[2]}.csv"
